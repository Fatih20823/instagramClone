    ...
    public void selectImage(View view) {
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED){
            if(ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
                Snackbar.make(view,"Permission needed for gallery(Galeri için izin gerekiyor)",Snackbar.LENGTH_INDEFINITE).setAction("Give Permission(İzin Ver?)", new View.OnClickListener() {
                    @Override
        ...
        permissionLauncher = registerForActivityResult(new ActivityResultContracts.RequestPermission(), new ActivityResultCallback<Boolean>() {
            ...
            public void onActivityResult(Boolean result) {
                if (result){
                    ...
                    Toast.makeText(UploadActivity.this,"Permission Needed(İzin gerekli)", Toast.LENGTH_LONG).show();
                }
            }
